        ...
        public MappingProfile()
        {
            ...
            CreateMap<Ucenik, UcenikResource>()
                ...
                .ForMember(v => v.Mesec, opt => opt.MapFrom(src => src.DatumRodjenja.Month))
                 ...
                 {
                     Id = src.Staratelji.SingleOrDefault().Id,
                     Ime = src.Staratelji.SingleOrDefault().Ime,
                     Prezime = src.Staratelji.SingleOrDefault().Prezime,
                     UcenikId = src.Staratelji.SingleOrDefault().UcenikId
                 }));
