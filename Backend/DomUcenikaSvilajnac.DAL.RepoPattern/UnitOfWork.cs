...
namespace DomUcenikaSvilajnac.DAL.RepoPattern
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(UcenikContext context, IMapper mapper,IHostingEnvironment environment)
        {
            ...
            Sobe = new SobaRepository(_context);
            GodisnjiProgramRada = new GodisnjiProgramRadaRepository(_context);
            MesecniPlanRada = new MesecniPlanRadaRepository(_context);
        }
        ...
        public ISobaRepository Sobe { get; set; }
        public IGodisnjiProgramRadaRepository GodisnjiProgramRada { get; set; }
      //  public IStatusPrijaveRepository StatusPrijave { get; set; }
        public IMesecniPlanRadaRepository MesecniPlanRada { get; set; }
