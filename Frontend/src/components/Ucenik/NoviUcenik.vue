                                ...
                                <v-card>
                                    ...
                                    <v-flex offset-sm1 xs12>
                                        <v-flex xs8 md5 class="ml-1">
                                            ...
                                            :rules="[rules.telefon]" clearable label="Broj telefona oca">
                                            </v-text-field>
                                        </v-flex>
                                    </v-flex>
                                    ...
                                    <v-flex offset-sm1 xs12>
                                        <transition name="fade" appear mode="in-out">
                                            <v-flex 
                                            v-if="editedItem.tipPorodice.id ===4 || editedItem.tipPorodice.id ===5 " 
                                            xs8 md5 
                                            class="ml-1">
                                                <v-text-field 
                                                color="navbarcolor" 
                                    ...
                                    <v-flex offset-sm1 xs12>
                                        <transition name="fade" appear mode="in-out">
                                            <v-flex 
                                            v-if="editedItem.tipPorodice.id ===4 || editedItem.tipPorodice.id ===5 " xs8 md5 class="ml-1">
...
export default {
    ...
    computed: {
        ...
        formIsValid() {
            if (this.editedItem.ime !== '' && this.rules.name(this.editedItem.ime) == true &&
                this.editedItem.prezime !== '' && this.rules.name(this.editedItem.prezime) == true &&
                this.editedItem.jmbg !== '' && this.rules.jmbg(this.editedItem.jmbg) == true &&
                this.editedItem.jmbg.length === 13 &&
                this.editedItem.pol.id !== '' &&
                this.editedItem.adresa !== '' &&
                ...
                this.editedItem.prethodniUspeh !== '' && this.rules.uspehX(this.editedItem.prethodniUspeh) == true &&
                (this.editedItem.telefon.mobilni == '' ||  this.rules.telefon(this.editedItem.telefon.mobilni) == true) &&
                (this.editedItem.telefon.kucni == '' ||  this.rules.telefon(this.editedItem.telefon.kucni) == true) &&
                (this.editedItem.roditelji[0].ime == '' ||  this.rules.name(this.editedItem.roditelji[0].ime) == true) &&
                (this.editedItem.roditelji[0].prezime == '' ||  this.rules.name(this.editedItem.roditelji[0].prezime) == true) &&
                //this.editedItem.roditelji[0].stepenObrazovanjaId !== '' &&
                (this.editedItem.roditelji[0].brojTelefona == '' ||  this.rules.telefon(this.editedItem.roditelji[0].brojTelefona) == true) &&
                (this.editedItem.roditelji[1].ime == '' || this.rules.name(this.editedItem.roditelji[1].ime) == true) &&
                (this.editedItem.roditelji[1].prezime == '' || this.rules.name(this.editedItem.roditelji[1].prezime) == true) &&
                //this.editedItem.roditelji[1].stepenObrazovanjaId !== '' &&
                (this.editedItem.roditelji[1].brojTelefona == '' ||  this.rules.telefon(this.editedItem.roditelji[1].brojTelefona) == true) &&
                this.editedItem.materijalniPrihodi !== '' && this.rules.materijalniPrihodiX(this.editedItem.materijalniPrihodi) == true &&
                (this.editedItem.staratelji.ime == '' ||  this.rules.name(this.editedItem.staratelji.ime) == true) &&
                (this.editedItem.staratelji.prezime == '' ||  this.rules.name(this.editedItem.staratelji.prezime) == true)
            ) {
                return true
            } else {
                return false
