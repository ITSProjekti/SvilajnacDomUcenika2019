  ...
  <div id="maindiv">
   <v-card>
    ...
    <v-card>
       ...
       <v-card-title wrap >
        <h3>Pregled svih primljenih učenika</h3> </v-card-title>
          </transition>
...
import axios from 'axios'
  ...
  export default {
    ...
    methods: {
      ...
      otvoriPDF() {
        var self = this;
        this.createPdfUrl();
        axios.get('http://192.168.1.44/api/ucenik/pdf'+ this.pdfUrl)
        .then(function (response) {
          self.dialogPDF = false;
          window.open("http://192.168.1.44/" + response.data)
        })
      ...
      openPDF() {
       ...
       var self = this;
        axios.post('http://192.168.1.44/api/Primljeni/', parametriZaPrijavu)
        .then(function (response) {
       ...
       PrijavljenUcenik(){
       this.form.post('http://192.168.1.44/api/Primljeni/1/1/30')
 ...
 /*      DugmeSubmit: function(){
        ...
        var vm = this;
        axios.get('http://192.168.1.44/api/Primljeni/10/10/10')
        .then(function(response){
