...
<v-container>
    <v-flex  xs12>
        ...
        Kreiraj novu karticu za evidenciju
        </v-btn >
    ...
    <v-dialog v-model="dialogNewGrupa" max-width="1000"> <!-- pocetak kartice -->
        <v-card id="novaKartica">
                    <v-card-title>
          <span class="headline">Kreiranje nove kartice za evidenciju</span>
        </v-card-title>
        <v-card-text>
            <v-container>  
                <v-layout row>
                      <v-flex offset-sm xs12>
              <v-flex xs20 class="ml-1" >
                <v-text-field
                  color="navbarcolor"
