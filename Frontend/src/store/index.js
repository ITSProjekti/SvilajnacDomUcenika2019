...
export const store = new Vuex.Store({
    ...
    mutations: {
         ...
         setLoadedGodisnjiProgram (state,payload)
         {
             state.godisnjiProgram=payload
         },
         setLoadedSobe (state,payload)
         {
             state.sobe=payload
         },
        setLoadedSastanak (state,payload)
        {
        ...
        setLoadedPrimljeni (state,payload){
            state.primljeni=payload
          
        },
        //setLoadedPDF(state,payload){
       //     state.pdf = payload
       // },
        ...
        createGodisnjiProgram(state,payload)
        {
            state.godisnjiProgram.push(payload)
        },
        createMesecni(state,payload)
        {
            state.mesecni.push(payload)
        },
        
        createSastanak(state,payload)
        {
            state.sastanci.push(payload)
        },
        createSoba(state,payload)
        {
            state.sobe.push(payload)
        },
        ...
        deleteGodisnjiProgram(state,payload)
        {
            state.godisnjiProgram.splice(payload.id)
        },
        ...
        deleteSastanak(state,payload)
        {
            state.sastanci.splice(payload.id)
        },
        deleteSoba(state,payload)
        {
            state.sobe.splice(payload.id)
        },
        ...
        editGodisnjiProgram(state,payload)
        {
            const godisnjiProgramEdit = state.godisnjiProgram.find(godisnjiProgramEdit =>{
                return godisnjiProgramEdit.id === payload.id
            })
            godisnjiProgramEdit.ProgramskoPodrucje = payload.ProgramskoPodrucje,
            godisnjiProgramEdit.Tema = payload.Tema,
            godisnjiProgramEdit.Mesec = payload.Mesec
        },
        editSoba(state,payload)
        {
            const sobaEdit = state.sobe.find(sobaEdit =>{
                return sobaEdit.id === payload.id
            })
            sobaEdit.BrojSobe = payload.BrojSobe,
            sobaEdit.Sprat = payload.Sprat,
            sobaEdit.VrstaSobe = payload.VrstaSobe,
            sobaEdit.TipSobe = payload.TipSobe
        },
    ...
    actions: {
       LoadedStatusiPrijave( {commit } ) {         
            ...
            axios.get('http://192.168.1.44:62768/api/statusiprijave').then((response) => {       
        ...
        loadedSastanak( {commit } ) {        
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/Sastanci').then((response) => {   
              commit('setLoadedSastanak', response.data)       
              commit('setLoading', false)       
            }).catch(
                (error) => {
                  console.log(error)
        ...
        loadedSSS( {commit } ) {
            ...
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/stepenistrucnespreme').then((response) => {
          ...
          loadedGodisnjiProgram( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/GodisnjiProgramRada').then((response) => {
                commit('setLoadedGodisnjiProgram', response.data)
              commit('setLoading', false)
          ...
          loadedMesecni( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/MesecniPlanRada').then((response) => {
                commit('setLoadedMesecni', response.data)
              commit('setLoading', false)
          ...
          loadedSobe( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/Sobe').then((response) => {
              
                commit('setLoadedSobe', response.data)
              commit('setLoading', false)
          ...
          loadedVaspitneGrupe( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/vaspitnegrupe').then((response) => {
            ...
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/vaspitaci').then((response) => {
          ...
          loadedKazne( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/kazne').then((response) => {
          ...
          loadedPohvale( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/pohvale').then((response) => {
          ...
          loadedTipoviPorodice( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/tipoviporodice').then((response) => {
        ...
        loadedRazred( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/razredi').then((response) => {
        ...
        loadedMesta( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/mesta').then((response) => {
        ...
        loadedOS( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/osnovneskole').then((response) => {
          ...
          loadedSS( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/srednjeskole').then((response) => {
        ...
        loadedSmerovi( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/smerovi').then((response) => {
        ...
        commit('setLoading', true)
        axios.get('http://192.168.1.44:62768/api/postanskiBrojevi').then((response) => {
      ...
      // HTTP GET zahtev za prikaz polova
        loadedPolovi( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/polovi').then((response) => {
        ...
        loadedUcenici( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/ucenik').then((response) => {
          ...
          loadedPrimljeni( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/Primljeni').then((response) => {
            
              commit('setloadedPrimljeni', response.data)
              commit('setLoading', false)
          ...
          loadedPDF( {commit } ) {
            ...
            axios.get('http://192.168.1.44:62768/api/ucenik').then((response) => {
              ...
              commit('setLoadedPDF', response.data)
              commit('setLoading', false)
          ...
          loadedOpstine( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/opstine').then((response) => {
          ...
          loadedDrzave( {commit } ) {
            commit('setLoading', true)
            axios.get('http://192.168.1.44:62768/api/drzave').then((response) => {
          ...
          createSastanak ({commit},payload) {
            const sastanak ={
                datum: payload.DatumOdrzavanja,
                brojPrisutnihUcenika: payload.brojPrisutnihUcenika,
                UkupanBrojPrisutnihUcenika: payload.UkupanBrojPrisutnihUcenika,
            ...
            axios.post('http://192.168.1.44:62768/api/Sastanci',sastanak, {
                ...
                commit('createSastanak', response.data)
                commit('setLoading', false)
                 }).catch(
                    (error) => {
                      console.log(error)
          ...
          createKazna ({commit},payload) {
            ...
            commit('setLoading', true)
            console.log(kazna)
            axios.post('http://192.168.1.44:62768/api/kazne',kazna, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
          ...
          const pohvala = {
            ...
            commit('setLoading', true)
            console.log(pohvala)
            axios.post('http://192.168.1.44:62768/api/pohvale',pohvala, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
        ...
        createGodisnjiProgram ({commit},payload) {
            const godisnjiProgram ={
                ProgramskoPodrucje: payload.ProgramskoPodrucje,
                Tema: payload.Tema,
                Mesec: payload.Mesec,
            }
            commit('setLoading', true)
   
            axios.post('http://192.168.1.44:62768/api/GodisnjiProgramRada',godisnjiProgram, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
               ...
               console.log(response.data)
                commit('createGodisnjiProgram', response.data)
                commit('setLoading', false)
                 }).catch(
                    (error) => {
                      console.log(error)
        ...
        createMesecni ({commit},payload) {
          const mesecni ={
            Mesec: payload.Mesec,
            SadrzajProgramaVaspitnogRada:payload.SadrzajProgramaVaspitnogRada,
            MetodeIObliciVaspitnogRada: payload.MetodeIObliciVaspitnogRada,
            Napomena: payload.Napomena,
            Literatura: payload.Literatura,
          }
          commit('setLoading', true)
 
          axios.post('http://192.168.1.44:62768/api/MesecniPlanRada',mesecni, {
              onUploadProgress: uploadEvent =>{
                  console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
              }
          }).then(function(response){
             ...
             console.log(response.data)
              commit('createMesecni', response.data)
              commit('setLoading', false)
               }).catch(
                  (error) => {
                    console.log(error)
        ...
        createSoba ({commit},payload) {
            const soba ={
                BrojSobe: payload.BrojSobe,
                Sprat: payload.Sprat,
                TipSobe: payload.TipSobe,
                VrstaSobe: payload.VrstaSobe
          
            }
            commit('setLoading', true)
   
            axios.post('http://192.168.1.44:62768/api/Sobe',soba, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
               ...
               console.log(response.data)
                commit('createSoba', response.data)
                commit('setLoading', false)
                 }).catch(
                    (error) => {
                      console.log(error)
          ...
          createVaspitnaGrupa ({commit},payload) {
            ...
            axios.post('http://192.168.1.44:62768/api/vaspitnegrupe',vaspitnaGrupa, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
        ...
        createVaspitac ({commit},payload) {
            ...
            axios.post('http://192.168.1.44:62768/api/vaspitaci',vaspitac, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
        ...
        createUcenik ({commit}, payload) {
            ...
            axios.post('http://192.168.1.44:62768/api/ucenik',ucenik, {
                onUploadProgress: uploadEvent =>{
                    console.log('Post request progress:' + Math.round(uploadEvent.loaded / uploadEvent.total * 100) + '%'  )                    
                }
            }).then(function(response){
        ...
        deleteVaspitnaGrupa( {commit },payload ) {
            ...
            axios.delete('http://192.168.1.44:62768/api/vaspitneGrupe/'+payload).then((response) => {
          ...
          deleteSastanak( {commit },payload ) {
            commit('setLoading', true)
           
            axios.delete('http://192.168.1.44:62768/api/Sastanci/'+payload).then((response) => {
              
              commit('deleteSastanak', response.data)
              commit('setLoading', false)
            })
          },
          deleteSoba( {commit },payload ) {
            commit('setLoading', true)
           
            axios.delete('http://192.168.1.44:62768/api/Sobe/'+payload).then((response) => {
              
              commit('deleteSoba', response.data)
              store.dispatch('loadedSobe')
              commit('setLoading', false)
            })
          },
          deleteGodisnjiProgram( {commit },payload ) {
            commit('setLoading', true)
           
            axios.delete('http://192.168.1.44:62768/api/GodisnjiProgramRada/'+payload).then((response) => {
              
              commit('deleteGodisnjiProgram', response.data)
              store.dispatch('loadedGodisnjiProgram')
              commit('setLoading', false)
            })
          },
          deleteKazna( {commit },payload ) {
            ...
            axios.delete('http://192.168.1.44:62768/api/kazne/'+payload).then((response) => {
          ...
          deletePohvala( {commit },payload ) {
            ...
            axios.delete('http://192.168.1.44:62768/api/pohvale/'+payload).then((response) => {
          ...
          deleteVaspitac( {commit },payload ) {
            ...
            axios.delete('http://192.168.1.44:62768/api/vaspitaci/'+payload).then((response) => {
        ...
        deleteUcenik( {commit },payload ) {
            ...
            axios.delete('http://192.168.1.44:62768/api/ucenik/'+payload).then((response) => {
          ...
          editVaspitneGrupe ({commit}, payload) {
            ...
            commit('setLoading', true)
            axios.put('http://192.168.1.44:62768/api/vaspitnegrupe/'+payload.id, vaspitneGrupe).then(function(response){
        ...
        commit('setLoading', true)
        axios.put('http://192.168.1.44:62768/api/Sastanci/'+payload.id, sastanak).then(function(response){
           
            commit('editSastanak', response.data)
            commit('setLoading', false)
             }).catch(
                (error) => {
                  console.log(error)
        ...
        commit('setLoading', true)
        axios.put('http://192.168.1.44:62768/api/Sobe/'+payload.id, sobe).then(function(response){
           
            commit('editSoba', response.data)
            commit('setLoading', false)
             }).catch(
                (error) => {
                  console.log(error)
      ...
      editGodisnjiProgram ({commit}, payload) {
        const godisnjiProgram = {
         id: payload.id,
         ProgramskoPodrucje: payload.ProgramskoPodrucje,
         Tema: payload.Tema,
    ...
    commit('setLoading', true)
    axios.put('http://192.168.1.44:62768/api/GodisnjiProgramRada/'+payload.id, godisnjiProgram).then(function(response){
       
        commit('editGodisnjiProgram', response.data)
        commit('setLoading', false)
         }).catch(
            (error) => {
              console.log(error)
          ...
          editVaspitaca ({commit}, payload) {
            ...
            commit('setLoading', true)
            axios.put('http://192.168.1.44:62768/api/vaspitaci/'+payload.id, vaspitac).then(function(response){
          ...
          editKazne ({commit}, payload) {
            ...
            commit('setLoading', true)
            axios.put('http://192.168.1.44:62768/api/kazne/'+payload.id, kazna).then(function(response){
          ...
          editPohvale ({commit}, payload) {
            ...
            commit('setLoading', true)
            axios.put('http://192.168.1.44:62768/api/pohvale/'+payload.id, pohvala).then(function(response){
          ...
          editUcenik ({commit}, payload) {
            ...
            console.log(ucenik)
            commit('setLoading', true)
            axios.put('http://192.168.1.44:62768/api/ucenik/'+payload.id, ucenik).then(function(response){
               console.log(response.data)
    ...
    getters: {
        ...
        loadedGodisnjiProgram (state) {
            return state.godisnjiProgram
        },
        loadedSastanak (state) {
   ...
   //     console.log(state.pdf)
    ...
    //},
        loadedOpstine (state) {     
         ...
         loadedBrojSobe (state) {  
            // console.log(state.sobe)    
             return state.BrojSobe       
          },
          
          loadedVrstaSobe (state) {  
            // console.log(state.sobe)    
             return state.VrstaSobe       
          },
          loadedTipSobe (state) {  
            // console.log(state.sobe)    
             return state.TipSobe       
          },
